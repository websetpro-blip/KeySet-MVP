...
def collect_frequency(
    ...
    *,
    ...
    for module, func in [
        ...
        ("services.frequency", "collect_frequency_ui"),
        ("services.frequency", "collect_frequency"),
        ("workers.full_pipeline_worker", "collect_frequency"),
    ]:
...
def collect_depth(
    ...
    *,
    ...
    for module, func in [
        ("services.frequency", "collect_depth"),
        ("workers.full_pipeline_worker", "collect_depth"),
    ]:
        payload = _call(
            module,
            func,
